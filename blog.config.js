...
const BLOG = {
  AUTHOR: 'Sunshine Yang', // 作者
  BIO: 'A soul that beyond identification.', // 作者简介
  LINK: 'https://gesnimbar.studio.site/', // 网站地址
  KEYWORDS: 'Notion, 博客, Blog', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '36b0959b61cc4c1f9027196ee73288dc', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'sunshine', // 主题， 支持 ['next','hexo',"fukasawa','medium','example'] @see https://preview.tangly1024.com
  ...
  CUSTOM_FONT_URL: ['https://fonts.googleapis.com/css2?family=Noto+Sans:ital,wght@0,300;0,400;1,300&family=Source+Serif+Pro:ital@1&display=swap'], // 自定义字体的CSS
  CUSTOM_FONT_SANS: ['Noto Sans'], // 自定义无衬线字体
  CUSTOM_FONT_SERIF: ['Noto Serif'], // 自定义衬线字体

  // 图标库CDN(可以直接改版本号）
  FONT_AWESOME_PATH: 'https://cdn.bootcdn.net/ajax/libs/font-awesome/6.2.0/css/all.min.css',

  BACKGROUND_LIGHT: '#E9EEEC', // use hex value, don't forget '#' e.g #fffefc
  BACKGROUND_DARK: '#1D2C44', // use hex value, don't forget '#'
  ...
  COMMENT_VALINE_APP_ID: process.env.NEXT_PUBLIC_VALINE_ID || 'RxmxdAnoaMeohzjCkBRtnA7V-MdYXbMMI', // Valine @see https://valine.js.org/quickstart.html 或 https://github.com/stonehank/react-valine#%E8%8E%B7%E5%8F%96app-id-%E5%92%8C-app-key
  COMMENT_VALINE_APP_KEY: process.env.NEXT_PUBLIC_VALINE_KEY || '1vblJfQz74cubSyIREdQcexN',
  COMMENT_VALINE_SERVER_URLS: process.env.NEXT_PUBLIC_VALINE_SERVER_URLS || '', // 该配置适用于国内自定义域名用户, 海外版本会自动检测(无需手动填写) @see https://valine.js.org/configuration.html#serverURLs
  COMMENT_VALINE_PLACEHOLDER: process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || 'Please feel free to share your thoughts〜', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Sunshines Unfolding Journey', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Discovering the light of my heart, deeper into the divinity of beings', // 站点描述，被notion中的页面描述覆盖
